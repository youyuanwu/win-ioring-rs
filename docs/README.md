...
| [performance.md](performance.md) | How this crate compares to `tokio::fs` on identical work, measured by Criterion with confidence intervals and baseline comparison, and what the measurement does and does not tell you |
