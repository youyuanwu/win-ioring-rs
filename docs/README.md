...
| [errors-and-the-funnel.md](errors-and-the-funnel.md) | Why classification funnels into one place while each public API reports its own error type, what the split cost, and why this document previously concluded the opposite |
